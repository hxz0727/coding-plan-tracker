...
> **最新更新：2026-09-20** ｜ 更新频率：每日 09:05（自动化）
...
- **⏰ 智谱 GLM-5.2 火山方舟 9/21 14:00 下线（明日）**：仅留 GLM-5.3，调用方须迁移；**智谱 GLM-5.3-FlashX 可作为更高吞吐替代**。
...
- **🟡 国内 Token Plan 9/1 集中调价（详见第三章各厂商段）**：火山方舟取消输入长度分段折扣（统一抵扣系数，短输入 ≤32k 约 +50%、长输入 >128k 下降），GLM-5.2 将于 9/21 下线仅留 5.3；腾讯 Token Plan 切换积分制 + 9/1–30 限时优惠（Auto / Kimi K2.7 Code / MiniMax-M3 五折，Hy4 preview / GLM-5.3 85 折）；阿里云百炼 Token Plan 个人版升级（取消 5 小时限额、新增 Qwen3.8-Max/Flash、DeepSeek-V4-Pro-0831、Wan3.0-Video，组合购 68 元起）；智谱 GLM-5.3-Flash 限时 5 折至 9/9（¥0.4 / ¥1.4 每百万）；百度千帆首购 5 折。
...
- **⏰ GLM-5.3-Flash 5 折 9/9 截止（仅剩 1 天）**：Z.ai 文档确认促销至 2026-9-9 24:00（新加坡 UTC+8），折后国际 \$0.075/\$0.25、国内 ¥0.4/¥1.4 每百万；**GLM-5.2 将于 2026-9-21 14:00 在火山方舟正式下线**，仅留 GLM-5.3。
...
| 事项 | 9/18 状态（前次） | 9/20 状态（最新） |
| --- | --- | --- |
| **Copilot 9/28 统一体验 + Balanced 默认** | 🔴 剩 10 天（官方 changelog 8/28 确认，静默涨价；数据终身留存） | 🔴 **剩 8 天**（官方 changelog 8/28 确认，静默涨价；数据终身留存） |
| **Copilot 10/1 新席位预付** | 🔴 剩 13 天（先付费后开通，撤销不退费） | 🔴 **剩 11 天**（先付费后开通，撤销不退费） |
| **Copilot 新注册重开** | 🟢 9/3 起重开（信用卡/PayPal） | 🟢 9/3 起重开（信用卡/PayPal） |
| **Copilot auto 模型选择「成本/质量」配置** | 🟢 9/14 上线；9/17 Claude Code 发布 Projects 重构 | 🟢 9/14 上线；HydraFusion 编排对外落地 |
| **GPT-6 Astra 发布** | 🟢 9/3 已发布，分阶开放中 | 🟢 9/3 已发布，分阶开放中 |
| **四模型退役切换** | 🟢 10/2 完成切换 | 🟢 10/2 完成切换 |
| **GPT-5.5 退役** | 🔴 拟 10/14 退役（剩约 26 天）：ChatGPT / Work / Codex 全档下线，API 不受影响，迁移至 GPT-5.6-Sol | 🔴 **拟 10/14 退役（剩约 24 天）**：ChatGPT / Work / Codex 全档下线，API 不受影响，迁移至 GPT-5.6-Sol |
| **火山方舟 2.5 折** | 🟢 剩 51 天（Lite ¥9.9 / Pro ¥49.9 首两月，至 11/8） | 🟢 **剩 49 天**（Lite ¥9.9 / Pro ¥49.9 首两月，至 11/8） |
| **GPT-5.6 Sol 促销** | 🟢 剩 64 天（$4/$20）；合作渠道限时折扣收口 | 🟢 **剩 62 天**（$4/$20）；Devin 7 折至 10/3 仍在 |
| **Gemini 3.8 Flash intro 价** | 🟢 剩 104 天（至 12/31，2027 翻倍 $1.50/$7.50） | 🟢 **剩 102 天**（至 12/31，2027 翻倍 $1.50/$7.50） |
| **智谱 GLM-5.3-Flash 5 折** | 🔴 已截止（9/10 起恢复刊例 $0.15/$0.50，国内 ¥0.8/¥2.8） | 🔴 **已截止**（9/10 起恢复刊例 $0.15/$0.50，国内 ¥0.8/¥2.8） |
| **智谱 GLM-5.3-FlashX 高速版** | — | 🟢 **9/18 发布**：200 tok/s 高速变体，国际 $0.37/$1.25、国内 ¥2/¥7 |
| **智谱 GLM-5.2 下线** | ⏰ 剩 3 天（火山方舟 9/21 14:00 下线，仅留 5.3） | ⏰ **剩 1 天（明日 9/21 14:00 下线，仅留 5.3）** |
| **智谱 GLM 夜间畅用** | 🟢 剩 2 天（至 9/20，23:00–9:00，GLM-5.3-Flash ZCode 内 0 额度） | 🟢 **今日（9/20）截止**（ZCode 内 0 额度窗口收尾；9/21 起恢复积分制） |
| **Z.ai 非高峰 1×** | ⏰ 约 12 天（至 9 月底） | ⏰ **约 10 天**（至 9 月底） |
| **DeepSeek V4.1 Flash 发布** | 🔥 9/10 已发布；V4 Pro→V4.1 Flash 路由 9/11 撤回未生效；V4.1 Pro 截至 9/18 仍未发布 | 🔥 9/10 已发布；V4 Pro 路由未生效（维持）；**V4.1 Pro 截至 9/19 仍未发布**（qcode.cc tracker） |
| **DeepSeek 科创板 IPO 筹备** | 🟢 已聘中信证券，计划年内启动；按 $710 亿投前估值融资、拟任首位 CFO | 🟢 已聘中信证券，计划年内启动；按 $710 亿投前估值融资、拟任首位 CFO |
| **国家超算 ¥9.9 促销** | ⚫ 618 限时（6/15–~7/15）已结束；现基础版活动价 ¥30/月 | ⚫ 618 限时已结束；现基础版活动价 ¥30/月 |
| **OpenAI 终止向 Cursor 直供模型** | 🔴 拟 11/12 终止（剩约 55 天） | 🔴 **拟 11/12 终止（剩约 53 天）** |
| **Kimi K3 登陆 AWS Bedrock** | — | 🟢 **9/19 上线**：月之暗面 K3 正式入 Amazon Bedrock，兑现 9/3 递表时云托管路线 |
| **Claude Code 2.1.278** | — | 🟢 **9/20 发布**：Auto 模式 pre-flight 安全检查移至 Anthropic 服务器，不再计费 |
| **Anthropic IPO** | ⏳ S-1 9/18「封面页泄露」传闻未证实；EDGAR 仍无公开 S-1；时间线维持 9 月下旬/10 月中旬/11 月 | ⏳ **9 月下旬窗口已开启（现 9/20），S-1 截至 9/20 晨仍无公开**（EDGAR 仅 6/1 机密 S-1）；维持 9 月下旬披露/10 月中旬路演/11 月上市、$2T、Nvidia 基石最高 $10B |
| **Anthropic cache-read 降价** | 🟢 9 月初已落地：cache-read 价格下调 75% | 🟢 9 月初已落地：cache-read 价格下调 75% |
| **Qwen3.8-Omni-Flash 发布** | 🟢 9/17 发布：原生全模态、音频价降 98%+ | 🟢 9/17 发布：原生全模态、音频价降 98%+ |
| **Moonshot/Kimi 港股 IPO** | 🟢 9/3 秘密递表，估值 $50B，募资 $3B | 🟢 9/3 秘密递表，估值 $50B，募资 $3B |
| **Stripe 收购 OpenRouter** | ⏳ 交割中（路由中立性待观察） | ⏳ 交割中（路由中立性待观察） |
| **OpenAI IPO** | ⏳ 推迟至 2027 | ⏳ 推迟至 2027 |
...
| GitHub Copilot | ✅ Free | Business/Enterprise 促销额度**已于 8/31 结束，9/1 起回落标准额度** | github.com | ⚠️ **Pro/Pro+/Student 自 4/20 起暂停新注册** |
...
- **9/8 落点复盘（新增）**：🚀 **GPT-6 Astra 发布重塑前沿定价锚（\$10/\$50，与 Fable 5.1 并列）**；🟢 Copilot 模型大换血（GPT-6 Astra/Fable 5.1 入选择器、四模型 10/2 退役、9/3 重开注册）+ 9/28/10/1 政策不变；🟢 **Anthropic IPO 时间线敲定**（S-1 9 月下旬、10 月路演、11 月上市、\$2T）；🔥 **Moonshot/Kimi 9/3 港股递表（\$50B、K3 兼容 Codex/Claude Code）**；🔥 **国产 Token 上架天猫「AI 空间站」**；🌙 智谱 GLM 夜间畅用（9/3–9/20）+ GLM-5.3-Flash 5 折 9/9 截止 + GLM-5.2 火山方舟 9/21 下线。
- **9/3 落点复盘**：🔥 Google Gemini 3.8 Flash 发布（\$0.75/\$3.75，intro 至 12/31）、Meta Muse Spark 1.3（价格持平 1.2）；🔵 Sonnet 5 永久 \$2/\$10 经 9/3 多源二次确认；Anthropic IPO 彭博披露目标估值 \$2T、最快 9–10 月；🟡 国内 Token Plan 9/1 集中调价（火山取消分段折扣/GLM-5.2 9/21 下线、腾讯切积分制+9 月优惠、阿里百炼个人版升级、智谱 GLM-5.3-Flash 5 折至 9/9）。
