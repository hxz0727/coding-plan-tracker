...
> **最新更新：2026-09-17** ｜ 更新频率：每日 09:05（自动化）
...
| 事项 | 9/16 状态（前次） | 9/17 状态（最新） |
| --- | --- | --- |
| **Copilot 9/28 统一体验 + Balanced 默认** | 🔴 剩 12 天（官方 changelog 8/28 确认，静默涨价；数据终身留存） | 🔴 **剩 11 天**（官方 changelog 8/28 确认，静默涨价；数据终身留存） |
| **Copilot 10/1 新席位预付** | 🔴 剩 15 天（先付费后开通，撤销不退费） | 🔴 **剩 14 天**（先付费后开通，撤销不退费） |
| **Copilot 新注册重开** | 🟢 9/3 起重开（信用卡/PayPal） | 🟢 9/3 起重开（信用卡/PayPal） |
| **Copilot auto 模型选择「成本/质量」配置** | 🟢 9/14 上线：auto 模式可调成本/质量权衡（HydraFusion 编排落地）；9/15 支持 custom properties 建议 | 🟢 9/14 上线；9/16 进一步发布「3-in-1」行内补全统一模型（completions + NES + long-distance NES） |
| **GPT-6 Astra 发布** | 🟢 9/3 已发布，分阶开放中 | 🟢 9/3 已发布，分阶开放中 |
| **四模型退役切换** | 🟢 10/2 完成切换 | 🟢 10/2 完成切换 |
| **GPT-5.5 退役** | — | 🔴 **拟 10/14 退役（剩约 27 天）**：ChatGPT / Work / Codex 全档下线，API 不受影响，迁移至 GPT-5.6-Sol（OpenAI 9/14 弃用通知） |
| **火山方舟 2.5 折** | 🟢 剩 53 天（Lite ¥9.9 / Pro ¥49.9 首两月，至 11/8） | 🟢 **剩 52 天**（Lite ¥9.9 / Pro ¥49.9 首两月，至 11/8） |
| **GPT-5.6 Sol 促销** | 🟢 剩 66 天（\$4/\$20） | 🟢 **剩 65 天**（\$4/\$20） |
| **Gemini 3.8 Flash intro 价** | 🟢 剩 106 天（至 12/31，2027 翻倍 \$1.50/\$7.50） | 🟢 **剩 105 天**（至 12/31，2027 翻倍 \$1.50/\$7.50） |
| **智谱 GLM-5.3-Flash 5 折** | 🔴 已截止（9/10 起恢复刊例 \$0.15/\$0.50，国内 ¥0.8/¥2.8） | 🔴 **已截止**（9/10 起恢复刊例 \$0.15/\$0.50，国内 ¥0.8/¥2.8） |
| **智谱 GLM-5.2 下线** | ⏰ 剩 5 天（火山方舟 9/21 14:00 下线，仅留 5.3） | ⏰ **剩 4 天**（火山方舟 9/21 14:00 下线，仅留 5.3） |
| **智谱 GLM 夜间畅用** | 🟢 剩 4 天（至 9/20，23:00–9:00，GLM-5.3-Flash ZCode 内 0 额度） | 🟢 **剩 3 天**（至 9/20，23:00–9:00，GLM-5.3-Flash ZCode 内 0 额度） |
| **Z.ai 非高峰 1×** | ⏰ 约 14 天（至 9 月底） | ⏰ **约 13 天**（至 9 月底） |
| **DeepSeek V4.1 Flash 发布** | 🔥 9/10 已发布；📌 9/14 硬路由已生效（误）；V4.1 Pro 截至 9/16 仍未发布 | 🔥 9/10 已发布；🔴 **9/14 V4 Pro→V4.1 Flash 自动路由已于 9/11 撤回、未生效**（OrcaRouter 9/17 复核：V4 Pro 仍正常服务、闲时 $0.66/$1.98）；**V4.1 Pro 截至 9/17 仍未发布** |
| **DeepSeek 科创板 IPO 筹备** | 🟢 已聘中信证券，计划年内启动 | 🟢 已聘中信证券，计划年内启动；据报按 $710 亿投前估值融资、拟任首位 CFO |
| **国家超算 ¥9.9 促销** | ⚫ 618 限时（6/15–~7/15）已结束；现基础版活动价 ¥30/月 | ⚫ 618 限时（6/15–~7/15）已结束；现基础版活动价 ¥30/月 |
| **OpenAI 终止向 Cursor 直供模型** | 🔴 拟 11/12 终止（剩约 57 天）：OpenAI 8/28 通知、post-SpaceX 收购，Cursor 模型连续性风险 | 🔴 **拟 11/12 终止（剩约 56 天）**：OpenAI 8/28 通知、post-SpaceX 收购，Cursor 模型连续性风险 |
| **Anthropic IPO** | ⏳ S-1 9/8 当周窗口已落空、9/16 晨仍未公开；现锚定 9 月下旬披露 / 路演不早于 10 月中旬 / 上市 11 月中期选举前；目标 $2T、拟设 $15B 循环信贷 | ⏳ **S-1 9/16 EDGAR 仍无公开（MEXC/AOL 9/16 确认）；现锚定 9 月下旬披露 / 路演不早于 10 月中旬 / 上市 11 月中期选举前；目标 $2T、Nvidia 基石最高 $10B** |
| **Moonshot/Kimi 港股 IPO** | 🟢 9/3 秘密递表，估值 \$50B，募资 \$3B | 🟢 9/3 秘密递表，估值 \$50B，募资 \$3B |
| **Stripe 收购 OpenRouter** | ⏳ 交割中（路由中立性待观察） | ⏳ 交割中（路由中立性待观察） |
| **OpenAI IPO** | ⏳ 6/8 秘密递交 S-1 草案，近期无公开时间表更新（观察项） | ⏳ **推迟至 2027**（Altman 确认今年不上市，ARR 破 $400 亿、环比 +20%） |
