...
> **最新更新：2026-09-09** ｜ 更新频率：每日 09:05（自动化）
...
| 事项 | 9/3 状态 | 9/8 状态（最新） |
| --- | --- | --- |
| **Copilot 9/28 统一体验 + Balanced 默认** | 剩 25 天 | 🔴 **剩 20 天**（官方 changelog 8/28 确认，静默涨价；数据终身留存） |
| **Copilot 10/1 新席位预付** | 剩 28 天 | 🔴 **剩 23 天**（先付费后开通，撤销不退费） |
| **Copilot 新注册重开** | — | 🟢 9/3 起重开 Business/Enterprise（信用卡/PayPal） |
| **GPT-6 Astra 发布** | — | 🟢 9/3 已发布，分阶开放中 |
| **四模型退役切换** | — | 🟢 9/3–9/4 公告，10/2 完成 |
| **火山方舟 2.5 折** | 剩 66 天（至 11/8） | 🟢 剩 61 天（Lite ¥9.9 / Pro ¥49.9 首两月） |
| **GPT-5.6 Sol 促销** | 剩 79 天（至 11/21） | 🟢 剩 74 天（\$4/\$20） |
| **Gemini 3.8 Flash intro 价** | 剩 119 天（至 12/31） | 🟢 剩 114 天（至 12/31，2027 翻倍 \$1.50/\$7.50） |
| **智谱 GLM-5.3-Flash 5 折** | 剩 6 天（至 9/9） | ⏰ **剩 1 天**（至 9/9 24:00 UTC+8，折后 \$0.075/\$0.25） |
| **智谱 GLM-5.2 下线** | — | ⏰ 剩 13 天（火山方舟 9/21 14:00 下线，仅留 5.3） |
| **智谱 GLM 夜间畅用** | — | 🟢 9/3–9/20（23:00–9:00，GLM-5.3-Flash ZCode 内 0 额度） |
| **Z.ai 非高峰 1×** | 约 27 天（至 9 月底） | ⏰ 约 22 天（至 9 月底） |
| **国家超算 ¥9.9 促销** | — | ⚫ 618 限时（6/15–~7/15）已结束；现基础版活动价 ¥30/月 |
| **Anthropic IPO** | 静默期 | ⏳ S-1 9 月下旬公开 / 10 月路演 / 11 月上市，目标 \$2T |
| **Moonshot/Kimi 港股 IPO** | — | 🟢 9/3 秘密递表，估值 \$50B，募资 \$3B |
...
| 🆕 **新开源多模态·再降价（国际）** | **智谱 GLM-5.3-Flash（320B）** | **国际 \$0.075 / \$0.25 每百万（8/29 再降 50%）；国内云 ¥0.8/¥2.8** | MIT 开源；国际价约 Opus 4.8 的 1/100 |
...
## 一、近期主要动态（2026 年 6–8 月 + 9/1–9/3 落点）
