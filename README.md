...
> **最新更新：2026-08-26** ｜ 更新频率：每日 09:05（自动化）
> 数据来源：各厂商官方定价页 / 官方文档 / 官方博客 + 第三方价格追踪（截至 2026-08-26 交叉验证）

---

## ⭐ 本期新增动态（2026-08-25 → 08-26）

### 1. 🔴 头条：Stripe ~\$75 亿收购 OpenRouter（8/20）—— AI 模型路由聚合器被支付巨头收编

8/20，全球支付基础设施巨头 **Stripe 正式宣布收购 AI 模型路由平台 OpenRouter**，金额据《纽约时报》《Axios》报道在 **70–80 亿美元**（创始人约 15 亿、投资者约 60 亿），较 OpenRouter 5 月 B 轮 1.13 亿美元、估值 13 亿美元**翻约 5 倍**；OpenRouter 接入 **80+ 供应商 400+ 款模型、日处理超 10 万亿 Token、月收入自 4 月以来增超 3× 至约 1,300 万美元**，竞购中击败 Databricks；交易预计数周内完成，**承诺产品 / 路线图 / 路由中立不变**。Stripe 同期还在洽谈 **530 亿美元收购 PayPal**。

- **为什么重要**：OpenRouter 是 token plan / API 聚合的核心入口（"按 token 计费、无最低消费、单参数切换模型"），被支付基础设施巨头收编意味着**模型路由层与支付层合流**；本仓第 9 条趋势「智能路由 = 省钱关键」的核心战场，其**路由中立性能否保持成最大悬念**——一旦路由被商业利益导向，开发者"哪便宜切哪"的杠杆可能受损。
- **资本侧对照**：与 8/22 "AI 泡沫已破裂"、8/25 中信建投看多算力形成多空对峙——**一级市场仍在高额下注 AI 分发层**，OpenRouter 估值 3 个月 5× 是最直接的注脚。

---

### 2. 🟢 头条：DeepSeek 8/23 优化峰谷计费规则——周末（周六日）全天统一按低谷价

8/23（周日）00:00 起，DeepSeek 在 8/17 峰谷基础上**细化计费规则**：工作日维持峰谷两档（**高峰 9:00–12:00、14:00–18:00**，其余为空闲；低谷 = 高峰½）；**周六、周日全天统一按低谷时段价格计费**。以旗舰 V4-Pro 为例：高峰 输入(缓存未命中) ¥9 / 输出 ¥27 / 缓存命中 ¥0.30；低谷 输入 ¥4.5 / 输出 ¥13.5 / 缓存命中 ¥0.15（= 高峰½）。

- **实质**：把"周末开发"成本再砍一刀，对国内个人 / 中小企业友好；但**工作日 7 小时高峰仍维持 8/17 的贵价**，结构性提价的本质不变。中银 / 国盛证券延续解读为"价值定价"信号——国产模型集体告别低价漩涡、掌握定价权。
- 📌 **订正**：8/25 报告仅记"峰谷 8/17 生效"，未捕获 8/23 周末规则；本期补全。同期 DeepSeek 还因"多家 AI 大厂集体涨价"再上热搜，腾讯云年内两次、智谱年内三次上调 API 价。

---

### 3. 🟡 资本：Anthropic IPO 加速（FT）——最快月底提交，估值或超 \$2 万亿、有望成史上最大 IPO

《金融时报》称 **Anthropic 最快 8 月底提交 IPO 文件**，估值或超 **2 万亿美元**、有望超越 SpaceX 成史上最大 IPO；2025 年净亏约 420 亿美元，公司同时洽谈新一轮 **100 亿美元融资**。

- **关联**：Anthropic 是 Claude Code / Opus 5 / Fable 5 / Sonnet 5 的出品方，其上市将把"AI 编程订阅 + Token 计费"这一本仓核心赛道推上**公开市场定价**；估值锚定直接影响同业（Cursor 被 xAI/SpaceX 收购后未独立上市、Copilot 背靠微软、智谱未上市）。
- **对照 Marshmallow/Melon**：IPO 窗口期恰逢新模型 EAP 预热，市场会给"既强又便宜"的拼图（Marshmallow 疑似 Opus 5.1）更高溢价。

---

### 4. ⏳ 关键倒计时状态更新（2026-08-26 视角）

| 事项 | 上期状态（8/25） | 本期状态（8/26） |
|---|---|---|
| **GLM-5.3 权重 MIT 开源** | ⏰ 8/28（剩 3 天） | ⏰ **剩 2 天**；同步启动"开源的盾"免费安全审计计划；OpenRouter 匿名模型 **Ox Alpha**（百万上下文、编程 Pass@1≈80%）高度指向智谱未发布旗舰 GLM-5.x |
| **火山方舟 2.5 折** | 🟢 至 2026-11-8（剩 74 天） | 🟢 **剩 74 天**（Lite ¥9.9 / Pro ¥49.9 首两月，官方文档确认 11/8 23:59:59 截止） |
| **Copilot 促销额度** | ⏰ 至 8/31（剩 6 天） | ⏰ **剩 5 天**，9 月账单跳涨（促销额度比基础高 60%–80%） |
| **Sonnet 5 锁价 \$2/\$10** | ✅ 至 8/31（剩 6 天） | ✅ **剩 5 天**（原 9/1 涨至 \$3/\$15 已取消） |
| **Claude Code 50% 用量加成** | ✅ 至 8/31（非永久） | ✅ **剩 5 天** |
| **GPT-5.4 自 Codex 退役** | ⏰ 8/31 同步截止 | ⏰ **剩 5 天** |
| **Kimi K2.5 API 下线 / 腾讯云 Hy3 preview 下线** | ⏰ 8/31（自动切 K2.6） | ⏰ **剩 5 天**，需提前迁移 |
| **Z.ai 非高峰 1× 扣额** | ⏰ 至 9 月底 | ⏰ 至 9 月底（约 36 天） |
| **DeepSeek 峰谷新价（含周末规则）** | 🔴 已生效（8/17） | 🔴 延续；8/23 起周末统一低谷价，**"固定费率退场"全行业确认** |

---

### 5. 🟢 价格战精确化（多源交叉验证）

- **GPT-5.6 Sol 8/21 确认降 20%/33%**：输入 \$5→\$4、输出 \$30→\$20，1M 输入 +1M 输出净降约 **31%**；**OpenRouter 路由再砍半至 \$2/\$10**；**前沿排序反转——Sol 现在比 Opus 5 便宜**（~\$0.22 vs ~\$0.275 / 30K 入 5K 出任务；输出降幅 33% > 输入 20%，精准打 Agent 高输出场景）。Sol \$4/\$20 限时约 3 个月（至 ~11/21）。
- **Gemini 3.7 Flash \$0.75/\$3.75 为限时**：2027/1/1 回涨至 \$1.50/\$7.50（翻倍）；Google 用 Flash 做"诱饵"引流、Pro 系列赚钱。
- **DeepSeek 峰谷 Peak 按 UTC 划分**：高峰 01:00–04:00、06:00–10:00 UTC（= 北京 9–12、14–18），**亚太商务时段多落在高峰（双倍）**，欧美多落低谷（默认便宜）；缓存命中高峰 ¥0.30 = 旧价 12×，依赖激进缓存的架构须重建成本模型。

---

### 6. 🔴 Cursor Auto 计量化后续 + 行业全面按量收敛

8/24 改按模型计费后社区持续反弹（indiekings 直呼 "bait-and-switch"、kilo.ai "All roads lead to metered pricing"）。补充细节：

- **Cursor Ultra 经 SuperGrok Heavy 含 Ultra 模型**；**Cursor 定价文档仍把 Auto 列为固定费率（未更新，透明度缺口）**——用户需到 Settings → Billing 核对实际扣费。
- **行业共识成型**：GitHub Copilot 退年付 + 严格按 token、Anthropic 用周限额替代涨价、Kilo/OpenRouter 走 passthrough（仅过路、不加成）——**"固定费率"退场已成全行业确认**；BYOK 仍收过路费（Cursor \$0.25/百万 token、含第三方模型）。
- 💡 **对策**：把重活（多文件重构 / 全项目解析）手动选低成本模型或盯紧 Usage 页；轻量任务仍可放心开 Auto（额度上调已对冲大部分消耗）。
...
| 🔴 成本重估 | **DeepSeek V4 系列** | 8/17 峰谷 + 8/23 周末规则 | 闲时仍便宜，高峰输出 4.5×；**周末统一低谷**；并发收紧（Flash 2500 / Pro 500） |
| 🟡 高性价比 | **腾讯云 TokenHub Pro** | ¥299/月 | 纯 1:1，≈¥0.93/百万，全市场最省心 |
| ⚠️ 限额大降 | **OpenCode Go** | \$10/月（首月 \$5） | V4-Flash 5h 限额 63,300→3,800（受 DeepSeek 涨价传导） |
| 🟢 聚合变局 | **OpenRouter（Stripe 收购中）** | 按 token、无最低消费 | 路由中立性成悬念；GPT-5.6 Sol 路由价已至 \$2/\$10 |
...
| **DeepSeek-V4-Flash（8/17 峰谷）** | ¥0.045（峰¥0.10） | ¥1.5（峰¥3） | ¥4.5（**峰¥9，输出 4.5×**） | 🔴 8/17 峰谷生效；闲时=峰价½；旧价命中0.02/未命中1/输出2（至8/16）；权重已 MIT 开源；**8/23 起周末全天统一低谷价** |
...
- **8/26（本期）视角更新**：Cursor Auto 8/24 起改按模型计量（固定费率退场，社区反弹持续，观察 Usage 页实际消耗）；**GLM-5.3 权重 MIT 开源剩 2 天（8/28）**，关注 HF `zai-org` 上架与 FP8 变体、最敏感网安能力是否随权重放出；**火山方舟 2.5 折实际至 2026-11-8（剩 74 天）**；**8/31** Copilot 促销额度到期 / Sonnet 5 锁价 \$2/\$10 截止 / Claude Code 50% 加成结束 / GPT-5.4 自 Codex 退役 / Kimi K2.5 API 下线 / 腾讯云 Hy3 preview 下线（剩 5 天）；**9 月底** Z.ai 非高峰 1× 扣额到期（约 36 天）；**Stripe 收购 OpenRouter 后路由中立性是否变** + **Anthropic IPO 进展（FT：月底提交、估值 >\$2T）**；**Anthropic Marshmallow/Melon 或 9 月发布（推测 Opus 5.1 / Sonnet 5.1）**，关注 8/31 后 Sonnet 5 价格结构是否调整、Fable 5 份额是否继续下滑；**开源 AI token 份额 62%（Vercel）**，闭源仍保留 60–90% 经济价值。
